(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(e){if(e.ep)return;e.ep=!0;const s=a(e);fetch(e.href,s)}})();const d=()=>`
  ...
  </div>`;document.getElementById("nav").innerHTML=d();const c=()=>`
...
`;document.getElementById("footer").innerHTML=c();document.getElementById("nav").innerHTML=d();document.getElementById("footer").innerHTML=c();window.onload=function(){const i=document.querySelectorAll(".nav-link"),t=window.location.hash;l(i,t),window.addEventListener("hashchange",function(){const a=window.location.hash;l(i,a)})};const l=(i,t)=>{i.forEach(function(a){a.getAttribute("href")===t?a.classList.add("active"):a.classList.remove("active")}),t===""&&i[0].classList.add("active")},o=({text:i,href:t,variant:a,className:n,target:e})=>`
...
`,p={404:{template:"/components/404.html",title:"404",description:"Page not found"},"/":{template:v(),title:"NK - Home",description:"This is the home page"},about:{template:_(),title:"NK - About",description:"This is the about page"},resume:{template:y(),title:"NK - Resume",description:"This is the resume page"},"mind-me":{template:w(),title:"NK - Resume",description:"MindMe - Case Study"},beanifesto:{template:b(),title:"NK - Beanifesto",description:"This is the beanifesto page"},itravel:{template:I(),title:"NK - iTravel",description:"This is the iTravel page"}},h=async()=>{var i=window.location.hash.replace("#","");i.length==0&&(i="/");const t=p[i]||p[404],a=t.template,n=document.getElementById("content");n.classList.add("fade"),await new Promise(s=>setTimeout(s,200));const e=document.getElementById("footer");n.innerHTML="",e.innerHTML="",await new Promise(s=>setTimeout(s,100)),n.innerHTML=a,e.innerHTML=c(),n.classList.add("show"),await new Promise(s=>setTimeout(s,200)),n.classList.remove("fade","show"),document.title=t.title};window.addEventListener("hashchange",h);h();
